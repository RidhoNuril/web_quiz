...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2025 at 10:15 AM
...
('136618', 'ucok', 'ucok', '2024-11-27 18:09:12', 'user'),
('1773647', 'Haya', 'haya123', '2024-11-27 11:35:08', 'user'),
('199657', 'Ridho', 'ridho123', '2024-11-27 11:00:31', 'user'),
('199785', 'zovi', 'zovi123', '2024-11-23 15:06:52', 'user'),
('219800', 'aris', 'aris', '2024-11-27 18:08:09', 'user'),
('23782', 'alda', 'alda', '2024-11-27 18:14:03', 'user'),
('23928392', 'mahdi', 'mahdi', '2024-11-27 20:47:08', 'user'),
('2738232', 'bayu', 'nayu', '2024-11-27 18:08:25', 'user'),
('3781783', 'agus', 'agus', '2024-11-27 18:08:41', 'user'),
('37823782', 'novan', 'novan', '2024-11-27 18:07:52', 'user'),
('admin', 'admin', 'admin', '2024-11-27 10:53:13', 'admin');
...
(16, 5, 'Latihan-2 IPA', 300, 'private', '2024-11-27 21:17:05');
...
INSERT INTO `quiz_score` (`id_score`, `user_nis`, `id_quiz`, `score`, `completed_at`) VALUES
(8, 'admin', 5, 40, '2025-01-08 07:57:41'),
(9, '199657', 5, 50, '2025-05-17 17:13:45');
...
--
ALTER TABLE `questions`
  MODIFY `id_question` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `quiz`
--
ALTER TABLE `quiz`
  MODIFY `id_quiz` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `quiz_score`
--
ALTER TABLE `quiz_score`
  MODIFY `id_score` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
